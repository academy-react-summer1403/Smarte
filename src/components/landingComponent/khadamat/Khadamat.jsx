...
const Khadamat = () => {
    return (
        ...
        <div>
            ...
            <div className='block md:hidden mb-36'>
                <div className='mx-auto flex justify-center flex-wrap w-[90%] mb-4'>
                    <img className='w-4 h-4 mt-2 ml-2' src="../../../../public/imgLand/Ellipse 5.png"/>
                    <h1 className='text-2xl font-extrabold'>
                        خدمات ما
                    </h1>
                </div>
                <p className='text-md font-bold text-slate-500 text-center mb-16'>
                    مجموعه ای از تمام آنچه شما نیاز دارید
                </p>
                <div className='flex justify-center gap-10 flex-wrap mx-auto w-[500px]'>

                    <div className="w-1/3 h-[180px] relative">
                        <img className='mx-auto w-1/3' src={Group6} />
                        <img className='absolute bottom-0 w-full h-[150px]' src={Rec15} />
                        <div className='relative w-1/2 mx-auto mt-3 mb-[50px]'>
                            <h2 className='z-10 absolute text-2xl inset-x-2 font-bold'>
                                مشاوره  
                            </h2>
                        </div>
                        <div className='w-11/12 relative mx-auto '>
                            <p className='z-10 absolute text-sm font-medium text-slate-500 text-center'>
                    ...
                    <div className="w-1/3 h-[180px] relative">
                        <img className='mx-auto w-1/3' src={Group5} />
                        <img className='absolute bottom-0 w-full h-[150px]' src={Rec14} />
                        <div className='relative w-1/2 mx-auto mt-3 mb-[50px]'>
                            <h2 className='z-10 absolute text-2xl inset-x-2 font-bold'>
                                مشاوره  
                            </h2>
                    ...
                    <div className="w-1/3 h-[180px] relative">
                        <img className='mx-auto w-1/3' src={Group4} />
                        <img className='absolute bottom-0 w-full h-[150px]' src={Rec13} />
                        <div className='relative w-1/2 mx-auto mt-3 mb-[50px]'>
                            <h2 className='z-10 absolute text-2xl inset-x-2 font-bold'>
                                مشاوره  
                            </h2>
                    ...
                    <div className="w-1/3 h-[180px] relative">
                        <img className='mx-auto w-1/3' src={Group3} />
                        <img className='absolute bottom-0 w-full h-[150px]' src={Rec12} />
                        <div className='relative w-1/2 mx-auto mt-3 mb-[50px]'>
                            <h2 className='z-10 absolute text-2xl inset-x-2 font-bold'>
                                مشاوره  
                            </h2>
            ...
            <div className='hidden md:block lg:hidden mb-36'>
                <div className='mx-auto flex justify-center flex-wrap w-[90%] mb-4'>
                ...
                <p className='text-lg font-bold text-slate-500 text-center mb-16'>
                    مجموعه ای از تمام آنچه شما نیاز دارید
                </p>
                <div className='flex justify-center gap-5 flex-wrap mx-auto'>

                    <div className="w-1/5 h-[180px] relative mt-20">
                        <img className='mx-auto w-1/3' src={Group6} />
                        <img className='absolute bottom-0 w-full h-[150px]' src={Rec15} />
                        <div className='relative w-1/2 mx-auto mt-3 mb-[50px]'>
                            <h2 className='z-10 absolute text-2xl inset-x-2 font-bold'>
                    ...
                    <div className="w-1/5 h-[180px] relative">
                        <img className='mx-auto w-1/3' src={Group5} />
                        <img className='absolute bottom-0 w-full h-[150px]' src={Rec14} />
                        <div className='relative w-1/2 mx-auto mt-3 mb-[50px]'>
                            <h2 className='z-10 absolute text-2xl inset-x-2 font-bold'>
            ...
            <div className='hidden lg:block xl:hidden mb-36'>
                ...
                <div className='flex justify-center gap-10'>
                    <div className="w-1/5 h-[260px] relative mt-[100px]">
                    ...
                    <div className="w-1/5 h-[260px] relative mb-[100px]">
